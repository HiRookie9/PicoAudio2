...
def merge_adjacent_segments(event_times, max_gap=1.0):
    ...
    for time_range in event_times:
        ...
        if start_time is None:
            ...
            # Merge if the gap is smaller than max_gap
            end_time = end
        else:
    ...
    for event_idx in range(num_events):
        ...
        for time_idx in range(time_steps):
            if output[event_idx, time_idx] >= threshold:
                ...
                if start_time is not None:
                    end_time = time_idx / 25.0  # Convert frame to seconds
...
if __name__ == "__main__":
    # 路径根据你的实际情况修改
    gen_jsonl_path = "/hpc_stor03/sjtu_home/zihao.zheng/x_to_audio_generation/exp/diffusion_pico_test/val_data_post_7.5_1/gen_audio.jsonl"
    caption_jsonl_path = "/hpc_stor03/sjtu_home/zihao.zheng/data/audiocaps_v2/eval_json/val_data_post_new/ref_caption.jsonl"
    onset_jsonl_path = "/hpc_stor03/sjtu_home/zihao.zheng/data/audiocaps_v2/eval_json/val_data_post_new/ref_onset.jsonl"
    output_jsonl_path = "/hpc_stor03/sjtu_home/zihao.zheng/x_to_audio_generation/exp/diffusion_pico_test/val_data_post_7.5_1/pred_onset.jsonl"
